    ...
    <>
      <section className="text-gray-400 bg-gray-900 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <motion.div animate={{opacity:1, x:96}} transition={{delay:0.4}} className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start opacity-0 md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <motion.div animate={{opacity:1, y: 96}} transition={{delay:0.5}} className="lg:max-w-lg relative -top-24 opacity-0 lg:w-full md:w-1/2 w-5/6">
            <img
