        ...
        <section class="text-gray-400 bg-gray-900 body-font">
          <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white transition-opacity opacity-0 delay-500">
            ...
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 hover:scale-105">
              <img
                class="object-cover object-center rounded rounded text-lg opacity-100 hover:scale-105 transition duration-700 ease-in-out rounded-xl"
                alt="hero"
      ...
      <section className="text-gray-400 bg-gray-900 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            ...
            />
=======
>>>>>>> f064435c66254f068bef3e3a8ecee862b114d148
          </div>
        </section>
...
<<<<<<< HEAD
      ...
      <section className="text-gray-400 bg-gray-900 body-font">
       <h1 className="title-font font-medium text-xl mb-2 text-white">About Us</h1>
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-800 bg-opacity-40 p-8 rounded">
                ...
                Welcome to Service Finder Name , your trusted destination for finding reliable services and connecting with skilled professionals in your community. At [Your Service Finder Name], we are dedicated to revolutionizing the way people discover and access essential services, making it easier than ever to find the help you need, when you need it.
Our Mission
                </p>
            ...
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-800 bg-opacity-40 p-8 rounded">
                ...
                <p className="leading-relaxed mb-6">
                At  Service Finder, our mission is to empower individuals and businesses by providing a convenient platform to discover, hire, and connect with local service providers. We are committed to simplifying the process of finding and booking services, while also supporting local economies and fostering community growth.
Our Vision
              ...
              <div className="p-4 md:w-1/2 w-full">
                <div className="h-full bg-gray-800 bg-opacity-40 p-8 rounded">
                  ...
                  <p className="leading-relaxed mb-6">
                    ...
                    appointments. It's like having a magic genie htmlFor your
                    home repairs and needs!"
                  </p>
                  <a className="inline-flex items-center">
                    <img
                      alt="testimonial"
              ...
              <div className="p-4 md:w-1/2 w-full">
                <div className="h-full bg-gray-800 bg-opacity-40 p-8 rounded">
                  ...
                  <p className="leading-relaxed mb-6">
                    ...
                    was able to compare different workers and choose the one
                    that fit my budget. I recently had my house painted, and the
                    workers were efficient, thorough, and even offered
                    cost-saving tips htmlFor future maintenance. It was a
                    hassle-free and afhtmlFordable experience overall."
                  </p>
                  <a className="inline-flex items-center">
                    <img
                      alt="testimonial"
